<?php
/**
 * Widget API: printera_Widget_About_Text class
 *
 * @package printera
 * @subpackage Widgets
 * @since 1.0.0
 ...
 * printera About Text
 */
function printera_recent_post() {
	register_widget( 'printera_Widget_About_Text' );
}
add_action( 'widgets_init', 'printera_recent_post' );
 ...
 * @see printera_Widget
 */
class printera_Widget_About_Text extends WP_Widget {
	...
	public function __construct() {
		...
		// Base ID of your widget.
			'printera_Widget_About_Text',
			// Widget name will appear in UI.
			__( 'printera About Text', 'printera' ),
			// Widget description.
			array( 'description' => esc_html__( 'printera About Text', 'printera' ) )
		);
	}
