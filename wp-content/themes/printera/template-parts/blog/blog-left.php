...
if ( is_active_sidebar( 'sidebar-1' ) ) { ?>
    <div class="col-lg-4 col-sm-12 left" id="post_content">
        <?php get_sidebar(); ?>
    </div>
    <?php
}
...
if ( is_active_sidebar( 'sidebar-1' ) ) { ?>
    <div class="col-lg-8 col-sm-12 right" id="post_sidebar">
    <?php } else { ?>
    <div class="col-lg-12 col-sm-12 right" id="post_content">
    <?php
}
	if ( have_posts() ) :
