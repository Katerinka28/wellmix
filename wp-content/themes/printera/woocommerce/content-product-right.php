	<?php
	echo '<div class="right-sidebar shop-sidebar">';

		echo '<div class="col-lg-9 col-sm-12 left-content-product shop-product" id="post_content">';
			if ( woocommerce_product_loop() ) {
				 ...
				 * 
				 * @hooked woocommerce_offsidebar_filter 15
				 * @hooked woocommerce_grid_list_view 10
				 * @hooked ps_selectbox 35
				 */
		...
		echo '<div class="col-lg-3 col-sm-12 sidebar-filter right-content-filter toggle-res" id="post_sidebar">';
				/**
