 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/content-short-view.php.
 *
...
<section <?php wc_product_class( '', $product ); ?>>
		<div class="product-content-wrap">
			...
			<?php
				 ...
				 */
				do_action( 'woocommerce_thumb_wrap_before_short' );
				 ...
				 */
				do_action( 'woocommerce_before_content_short' );

					echo '<div class="list-content col-md-6 col-12">';
					...
					echo '<div class="list-price col-xl-3 col-md-2 col-12">';
					...
					echo '<div class="list-cart-wrap col-xl-3 col-md-4 col-12">';
