...
echo '<div class="left-sidebar shop-sidebar">';

	echo '<div class="col-lg-3 col-sm-12 sidebar-filter left-content-filter toggle-res" id="post_sidebar">';
		/**
	...
	echo '<div class="col-lg-9 col-sm-12 shop-product right-content-product" id="post_content">';
